import { loadData, saveData, exportData, importData, resetData } from './storage-v1.2.0.js?v=1.2.0';
import { uid, esc, fmtDate, reputationLabel, reputationPercent, hoursUntil, activeGraffitis, getNextTurn, countdownText, territoryState, recommendation } from './utils-v1.2.0.js?v=1.2.0';
...
function renderCurrent(){
  ({dashboard:renderDashboard,operations:renderOperations,graffiti:renderGraffiti,criminal:renderCriminalActs,logistics:renderLogistics,events:renderEvents,members:renderMembers,builder:renderBuilder,settings:renderSettings}[currentView])();
}
